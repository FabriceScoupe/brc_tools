...
def parse_arguments():
    ...
    parser.add_argument('-r', '--reference', help='reference to add (repeatable)', metavar=('name', 'uri'),
...
if __name__ == '__main__':
    ...
    references = config.pop('reference', [])
    ...
    for r in references:
        ledger.add_reference({'name': r[0], 'uri': r[1]})
